...
wstring editionDate = L"20250327b";				// 程序发布日期
...
// int main()
{
	...
	// 窗口
	{
		...
		hiex::PreSetWindowStyleEx(WS_EX_NOACTIVATE);
		ppt_window = hiex::initgraph_win32(MainMonitor.MonitorWidth, MainMonitor.MonitorHeight, 0, L"Inkeys2 PptWindow", (L"Inkeys1245;" + ClassName).c_str(), nullptr, /*drawpad_window*/setting_window);
