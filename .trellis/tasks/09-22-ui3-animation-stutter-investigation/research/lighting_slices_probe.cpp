...
// Extracted body SHA256: c0bfe72478de461d236f11c2655c2a08ab41157a2770811e4ca462d6ff6de763
...
int main() {
    ...
    for (const FLOAT zoom: {1.0F,1.3F}) {
        ...
        std::cout << "verbatim production bodies: zoom=" << zoom << ", shapes=15, FillOpacityMask_calls=" << context.calls << '\n';
    }
}
