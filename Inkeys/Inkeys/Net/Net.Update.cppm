...
export module Inkeys.Net.Update;

export class EditionInfoClass
{
public:
	EditionInfoClass() {}
...
export EditionInfoClass GetEditionInfo(string channel, string arch);

export enum class AutomaticUpdateStateEnum : int
{
...
export extern AutomaticUpdateStateEnum AutomaticUpdateState;

export class DownloadNewProgramStateClass
{
public:
...
export extern DownloadNewProgramStateClass downloadNewProgramState;
...
//程序自动更新
export extern bool mandatoryUpdate;
export extern bool inconsistentArchitecture;
